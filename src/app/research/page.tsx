...
export default function ResearchPage() {
  return (
    <main className="page-shell">
      ...
      <Link className="research-item" href="/research/cpu-scheduling">
        <span>Operating System · 2026.08.20</span>
        <h2>CPU 스케줄링</h2>
        <p>CPU·입출력 버스트와 스케줄링 큐부터 선점 여부, 주요 CPU 스케줄링 알고리즘까지 정리합니다.</p>
        <strong>읽어보기 →</strong>
      </Link>
