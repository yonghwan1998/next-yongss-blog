  ...
  return (
    <main className="page-shell">
      ...
      {projectEntries.length === 0 ? (
        ...
        <section className="projects-list" aria-label="프로젝트 목록">
          {projectEntries.map((project) => (
            <article
              className={`project-card${project.preview ? "" : " project-card--text-only"}`}
            ...
            >
              <div className="project-card-content">
                ...
                <ul className="project-technologies" aria-label={`${project.title} 기술 스택`}>
              ...
              {project.preview ? (
                <div className="project-card-preview">
                  <Image
                    ...
                    sizes="(max-width: 760px) calc(100vw - 72px), 300px"
